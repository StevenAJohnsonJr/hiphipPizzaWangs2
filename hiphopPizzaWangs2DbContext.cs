...
namespace hiphipPizzaWangs2
{
    public class hiphopPizzaWangs2DbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new User { Id = "ZjnYscBnyAOQCwSCi1NWLYjo6bs1", FirstName = "Trent", LastName = "Jones", OrderId = 1, PhoneNumber = "6157523654", Email = "jones@jones.com" },
                new User{ Id = "UniqueUidForJohn", FirstName = "John", LastName = "James", OrderId = 2, PhoneNumber = "6157548796", Email = "jj123@nss.com" },
                new User{ Id = "UniqueUidForSam", FirstName = "Sam", LastName = "Tronset", OrderId = 3, PhoneNumber = "8132547486", Email = "stron234@makeit.com" },
                new User { Id = "UniqueUidForSusan", FirstName = "Susan", LastName = "McJohnny", OrderId = 4, PhoneNumber = "2154526341", Email = "helpfulsusan9541@chsarp.com" },
                new User { Id = "UniqueUidForBobby", FirstName = "Bobby", LastName = "Castle", OrderId = 5, PhoneNumber = "9872154897", Email = "bobk1ngs@betdes.com" }
            });
            ...
            {
                new Order {Id = 1, OrderId = 15, CustomerName = "Hungry Mann", OrderDate = new DateTime(2023, 6, 28), OrderStatus = "Pending", Tip = 3, PaymentsId = 1, TotalRev = "2099", Like = true  },
                new Order {Id = 2, OrderId = 22, CustomerName = "Shorty Duwop", OrderDate = new DateTime(2023, 9, 08), OrderStatus = "Pending", Tip = 5, PaymentsId = 3, TotalRev = "9099", Like = true  },
                new Order {Id = 3, OrderId = 8, CustomerName = "Sherry Lovington", OrderDate = new DateTime(2023, 2, 14), OrderStatus = "In-Progress", Tip = 2, PaymentsId = 4, TotalRev = "2099", Like = true  },
                new Order {Id = 4, OrderId = 18, CustomerName = "Starving Joe", OrderDate = new DateTime(2023, 2, 23), OrderStatus = "Completed", Tip = 3, PaymentsId = 5, TotalRev = "1699", Like = true  },
                new Order {Id = 5, OrderId = 6, CustomerName = "Feed MeNow", OrderDate = new DateTime(2023, 10, 2), OrderStatus = "Pending", Tip = 3, PaymentsId = 2, TotalRev = "2099", Like = true  },
            });
