...
namespace hiphipPizzaWangs2
{
    public class hiphopPizzaWangs2DbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Order {Id = 1, OrderId = 15, CustomerName = "Hungry Mann", OrderDate = new DateTime(2023, 6, 28), OrderStatus = "Pending", Tip = 3, PaymentsId = 1, TotalRev = 20.99, Like = true  },
                ...
                new Order {Id = 3, OrderId = 8, CustomerName = "Sherry Lovington", OrderDate = new DateTime(2023, 2, 14), OrderStatus = "In-Progress", Tip = 2, PaymentsId = 4, TotalRev = 20.99, Like = true  },
                new Order {Id = 4, OrderId = 18, CustomerName = "Starving Joe", OrderDate = new DateTime(2023, 2, 23), OrderStatus = "Completed", Tip = 3, PaymentsId = 5, TotalRev = 16.99, Like = true  },
                new Order {Id = 5, OrderId = 6, CustomerName = "Feed MeNow", OrderDate = new DateTime(2023, 10, 2), OrderStatus = "Pending", Tip = 3, PaymentsId = 2, TotalRev = 20.99, Like = true  },
            });
